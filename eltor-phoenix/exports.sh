...
export APP_ELTOR_HOST="eltor-phoenix_web_1"

######################################
### App env vars
######################################
export APP_ELTOR_FRONTEND_PORT="5163"
export APP_ELTOR_BACKEND_PORT="5164"
...
### LN env vars
######################################
export APP_ELTOR_USE_PHOENIXD_EMBEDDED=true
...
export APP_ELTOR_TOR_CONTROL_PORT="9993"
# password1234_
...
export APP_ELTOR_TOR_RELAY_OR_PORT="9994"
export APP_ELTOR_TOR_RELAY_CONTROL_PORT="7781"
export APP_ELTOR_TOR_RELAY_SOCKS_PORT="18066"
# password1234_
